<nav class="navbar navbar-expand-lg navbar-light bg-light rounded">
  <div class="container-fluid p-0 pe-lg-2">
    <div class="d-flex">
      <form class="d-flex me-lg-3 mx-lg-3 ps-2 ps-lg-0">
    ...
    <div class="collapse navbar-collapse d-lg-flex justify-content-end px-3 px-lg-0" id="navbarTogglerprodbar">
      <ul class="navbar-nav mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link text-dark" href="#">Chapas</a>
        </li>
        <li class="nav-item">
          <a class="nav-link text-dark" href="#">Telas</a>
        </li>
        <li class="nav-item">
          <a class="nav-link text-dark" href="#">Barras</a>
        </li>
        <li class="nav-item">
          <a class="nav-link text-dark" href="#">Arames</a>
        </li>
        <li class="nav-item">
